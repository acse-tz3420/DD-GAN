...
def reconstruct(
    ...
    reconstructed_file_location="./../../data/outputs/",
    reconstructed_file="aae_next_1000.npy",  # POD coefficients
    #pod_results_file="outputs/mlp_deriv_1000.npy",
    #pod_basis_file="processed/pod_basis_1.npy",
    nGrids=1,
    xlength=2.2,
    ylength=0.41,
    nTime=50,
    ...
    Args:
        ...
        snapshot_file_base (str, optional): file base of sample vtu file.
                                            Defaults to "fpc_".
        reconstructed_file_location (str, optional): location of reconstruction data file.
                                                     Defaults to
                                                     "./../../data/outputs/".
        reconstructed_file (str, optional): reconstruction data file. Defaults
                                            to "pod_coeffs_n5.npy".
        ...
        field_names (list, optional): names of fields in vtu file. Defaults to
                                      ["Velocity"].
        offset (int, optional): starting timestep. Defaults to 1.
    """
    ...
    reconstructed = np.load(reconstructed_file_location + reconstructed_file)
    ...
    path_to_reconstructed_results = "./../../data/reconstructed/aae_next_1000/"
